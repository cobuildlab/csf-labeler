...
def generate_label(lot, count, weight_str):
    ...
    draw.text((middle, text_1), str(weight_str) + ' lb   x', fill='black', anchor='ms', font=header_fnt)
    draw.text((middle, text_2), uniq_id, fill='black', anchor='ms', font=body_fnt)
    draw.bitmap((50, draw_1), qr_bitmap, fill= 'black')
    draw.text((middle, text_3), day_name, fill='black', anchor='ms', font=body_fnt)
    draw.text((middle, text_4), day_date, fill='black', anchor='ms', font=body_fnt)
    draw.text((middle, text_5), day_time, fill='black', anchor='ms', font=body_fnt)
    draw.text((middle, text_6), printer_serial, fill='black', anchor='ms', font=serial_fnt)
