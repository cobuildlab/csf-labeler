...
from printer import Printer, get_printer_serial
...
class ButtonsReader(Thread):
    ...
    def start_new_lot(self, reset_day_lot=False):
        self.day_lot = 0 if reset_day_lot is True else self.day_lot + 1
        self.count = 0
            ...
            try:
                ...
                for event in self.buttons_pad.read_loop():
                    ...
                    if event.code == self.yellow_btn:
                        ...
                        if previous_event_code == self.yellow_btn:
                            self.start_new_lot(True)
                        else:
                            self.start_new_lot()
                    ...
                    # we always store the last event.code
